...
import "./LegacyAgreementEngine.sol";

/**
 * @title LegacyAgreementFactory
 * @notice Frozen reference factory deploying LegacyAgreementEngine clones (EIP-1167).
 * @dev Pinned copy of the current AgreementFactory for the R1 differential parity spike.
 *      Behavior identical to AgreementFactory; only the implementation type name differs.
 */
contract LegacyAgreementFactory is ReentrancyGuard, EIP712 {
    using Clones for address;

    /// @notice The LegacyAgreementEngine implementation contract address
    ...
    /**
     * @notice Create a new factory pointing to an LegacyAgreementEngine implementation
     * @param implementation_ Address of the LegacyAgreementEngine implementation contract
     */
    ...
    function createAgreement(
        ...
        LegacyAgreementEngine.InputDef[] calldata inputDefs_,
        LegacyAgreementEngine.Transition[] calldata transitions_,
        LegacyAgreementEngine.DataField[] calldata initVars_,
        LegacyAgreementEngine.ActionInit[] calldata actions_
        ...
        LegacyAgreementEngine(agreement).initialize(
            msg.sender,
            docUri,
            docHash,
            initialState,
