 ...
 */
contract LegacyAgreementEngine is Initializable, ReentrancyGuard, EIP712 {
    // ========================================================================
    // TYPES & ENUMS
    // ========================================================================
    ...
    function getVar(bytes32 fieldId)
        external
        view
        returns (bool set, FieldType fType, bytes memory data)
    {
        StoredVar storage v = vars[fieldId];
